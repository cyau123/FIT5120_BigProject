...
<button id="open-in-maps-btn"><i class="fas fa-external-link-alt"></i> Open in Google Maps</button>
  ...
  polylineOptions: {
    ...
    var kinderIcon = "https://img.icons8.com/ios-filled/50/null/marker-k.png";

    legend.innerHTML = '<p id="legend-header" style="margin-bottom:0px;">Legend</p>' +
  '<div id="legend-content">' +
  '<p style="margin-top:20px;"><img src="' + userIcon + '"> Home</p>' +
  '<p><img src="' + kinderIcon + '"> Kinder</p>' +
  '</div>';
